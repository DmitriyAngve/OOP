...
class Account {
  constructor(owner, currency, pin) {
    ...
    this.pin = pin;
    this.movements = []; // replace from argument
...
// Bad idea (need to create method)
...
acc1.approveLoan(1000); // accessible

console.log(acc1);
console.log(acc1.pin); // accessible
*/
...
/////////////////////////////////////////////////////////////////////
/*
// Underscore ahead of method make this method private
class Account {
  constructor(owner, currency, pin) {
    this.owner = owner;
    this.currency = currency;
